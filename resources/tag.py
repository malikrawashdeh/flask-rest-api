...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        tag = TagModel.query.get_or_404(item_id)
    ...
    def delete(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="An error occured while deleting tag")
...
class Tag(MethodView):
    ...
    @blp.response(
        202,
        description="Deletes a tag if no item is tagged with it", example={"message": "Tag deleted"}
        )
